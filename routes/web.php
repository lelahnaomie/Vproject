...
Route::get('zktrait/att', [ZkController::class, 'att']);
Route::get('zktrait/store', [ZkController::class, 'store']);
Route::get('recordtrait/user', [RecordController::class, 'user']);
Route::get('recordtrait/store', [RecordController::class, 'store']);
Route::get('recordtrait/index', [RecordController::class, 'index']);
Route::get('zktrait/todayData', [ZkController::class, 'todayData']);
Route::get('zktrait/monthlyData', [ZkController::class, 'monthlyData']);

Route::get('zktrait/allData', [ZKController::class, 'allData']);

// // Route::get('/attendance', [AttendanceController::class, 'showAttendanceDatatable']);
