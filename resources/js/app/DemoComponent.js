...
Vue.component('dashboard-attendance', require('./Components/Views/Demo/Dashboard/Attendance').default);
Vue.component('dashboard-ratings', require('./Components/Views/Demo/Dashboard/Ratings').default);
Vue.component('dashboard-employee', require('./Components/Views/Demo/Dashboard/Employee').default);
Vue.component('dashboard-department', require('./Components/Views/Demo/Dashboard/Department').default);
Vue.component('dashboard-workinghour', require('./Components/Views/Demo/Dashboard/WorkingHour').default);
Vue.component('dashboard-record', require('./Components/Views/Demo/Dashboard/Records').default);
...
Vue.component('app-employee-modal', require('./Components/Views/Demo/Tables/demo-crud/EmployeeModal').default);
Vue.component('app-department-modal', require('./Components/Views/Demo/Tables/demo-crud/DepartmentModal').default);
Vue.component('app-workinghour-modal', require('./Components/Views/Demo/Tables/demo-crud/WorkinghourModal').default);
Vue.component('app-record-modal', require('./Components/Views/Demo/Tables/demo-crud/RecordModal').default);