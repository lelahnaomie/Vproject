...
export const DEFAULT_RECORD_INFO = 'default-academic-info';
export const DEFAULT_ATTENDANCE_INFO = 'default-attendance-info';
...
export const LATENESS_OVERVIEW = 'lateness-overview';
...
export const WORKINGHOUR_INFO = 'default-working-hour-info';
export const DEFAULT_EMPLOYEE_INFO = 'default-employee-info';
...
//attendanceDataTable
export const ATTENDANCE_DATA= 'zktrait/allData';
export const ATTENDANCE_SEARCH_SELECT= '/employee';
export const ATTENDANCE_SERVER_SEARCH_SELECT = 'zktrait/allData';

//department datatable
export const DEPARTMENT_DATA= 'department';

//working datatable
export const WORKINGHOUR_DATA= 'workinghour';

//employeetable
export const EMPLOYEE_DATA= 'employee';
export const EMPLOYEE_DATA_INFO = 'employee';
export const EMPLOYEE_SEARCH_SELECT= '/datatable/name';
export const EMPLOYEE_SERVER_SEARCH_SELECT = '/datatable/serverside/selectable-name';

//recordtable
export const RECORD_DATA = 'recordtrait/index';
export const RECORD_DATA_INFO = 'record';
export const RECORD_SEARCH_SELECT= '/datatable/name';
export const RECORD_SERVER_SEARCH_SELECT = '/datatable/serverside/selectable-name'
