                    ...
                    <div class="card card-with-shadow border-0 h-100" v-if="isActiveStudentOverview">
                        <div
                            ...
                            <ul class="nav tab-filter-menu justify-content-flex-end">
                                <li class="nav-item"
                                    v-for="(item, index) in attendancedashboard.studentOverview.filters" :key="index">
                        ...
                        <div class="card-body">
                            ...
                            <div class="chart-data-list">
                                <div class="row">
                                    <div class="col-12"
                                        v-for="(item, index) in attendancedashboard.latenessOverview.chartElement"
                                        :key="index">
...
export default {
    ...
    data() {
        return {
            ...
            isActiveLatenessOverview: false,
            ...
            options: {
                ...
                filters: [
                    ...
                    // },
                    {
                        ...
                        "option": [
                            { id: 'checkin', value: 'IN' },
                            { id: 'checkout', value: 'OUT' },
                        ],
                    },
                    // {
                    //     "title": this.$t('checkIn/Out'),
                    //     "type": "radio",
                    //     "key": "filter-with-CheckIn/Out",
                    //     "option": [
                    //         {id: 'IN', value: 'CheckIN'},
                    //         {id: 'Out', value: 'CheckOUT'},
    ...
    methods: {
        ...
        defaultData() {
            let url = actions.DEFAULT_ATTENDANCE_INFO;
        ...
        latenessOverview() {
            let url = actions.LATENESS_OVERVIEW;

            this.axiosGet(url).then(response => {

                this.attendancedashboard.latenessOverview = response.data;
                this.isActiveLatenessOverview = true;
