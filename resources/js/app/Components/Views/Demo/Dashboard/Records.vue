<template>
    <div class="position-relative">
        ...
        <div class="content-wrapper">
            <app-breadcrumb :page-title="$t('Records')" :directory="$t('dashboard')" :icon="'pie-chart'" />
            <div class="content-wrapper">

                <div class="row">
                <div class="col-sm-12 col-md-6">
                    <app-breadcrumb :page-title="$t('Record List')" :directory="$t('datatables')" :icon="'grid'" />
                </div>
                ...
                <app-record-modal v-if="isAddEditModalActive" :table-id="tableId" :selected-url="selectedUrl"
...
import { TableHelpers } from '../Tables/mixins/RecordHelpers';
...
export default {
    ...
    methods: {
        ...
        defaultData() {
            let url = actions.DEFAULT_RECORD_INFO;
    ...
    */
        ...
        getListAction(rowData, actionObj, active) {
            ...
            if (actionObj.title == 'Delete') {
                ...
                this.selectedUrl = `${actions.RECORD_DATA}/${rowData.id}`;
         ...
         */
        confirmed() {
            let url = `${actions.RECORD_DATA}/${this.rowData.id}`;
