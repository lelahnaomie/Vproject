        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <app-breadcrumb :page-title="$t('Working Hour List')" :directory="$t('datatables')" :icon="'grid'" />
                </div>
            ...
            <app-workinghour-modal v-if="isAddEditModalActive" :table-id="tableId" :selected-url="selectedUrl"
...
import { TableHelpers } from '../Tables/mixins/WorkingHourHelpers';
    ...
    */
        ...
        getListAction(rowData, actionObj, active) {
            ...
            if (actionObj.title == 'Delete') {
                ...
                this.selectedUrl = `${actions.WORKINGHOUR_DATA}/${rowData.id}`;
         ...
         */
        confirmed() {
            let url = `${actions.WORKINGHOUR_DATA}/${this.rowData.id}`;
