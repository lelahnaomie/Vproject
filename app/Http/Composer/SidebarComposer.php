...
class SidebarComposer
{
    public function compose(View $view)
    {
        ...
        $menu = [
            ...
            [
            'id'  => 'attendance-sample',
            'icon' => 'pie-chart',
            'name' => "Attendance",
            'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
                'subMenu' => [
                    [
                        'url' => request()->root() . '/dashboard/attendance',                
                        'icon' => 'pie-chart',
                        'name' => "Attendance",
                        'permission' => auth()->user()->can('manage_filter_type_datatable') || 
                        authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
                    ],
                    [
                        'url' => request()->root() . '/dashboard/records',                
                        'icon' => 'pie-chart',
                        'name' => "Records",
                        'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
                    ],
            ...
            [
                'url' => request()->root() . '/dashboard/ratings',                
                'icon' => 'pie-chart',
                'name' => "Ratings",
                'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
            ],
            [
                'url' => request()->root() . '/dashboard/employees',                
                'icon' => 'pie-chart',
                'name' => "Employees",
                'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
            ],
            [
                'url' => request()->root() . '/dashboard/department',                
                'icon' => 'pie-chart',
                'name' => "Department",
                'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
            ],
            [
                'url' => request()->root() . '/dashboard/working-hour',                
                'icon' => 'pie-chart',
                'name' => "Working Hour",
                'permission' => authorize_any(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
            ],
