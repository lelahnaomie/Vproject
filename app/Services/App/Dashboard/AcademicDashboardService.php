...
class AcademicDashboardService extends AppService
{
    ...
    public function schoolOverview()
    {
        ...
        $random_array = $this->getLatecomersByDepartment(4);

        $labels = [
            trans('default.developer'),
            trans('default.media'),
            trans('default.plugins'),
            trans('default.tech_support')
        ];
    ...
    {
        $labels = ['Charles', 'Jonathan', 'Devol', 'Chiris', 'Andrew'];
        ...
        $data_set = [
            [
                ...
                'data' => [mt_rand(300, 500), mt_rand(300, 500), mt_rand(300, 500), mt_rand(300, 500), mt_rand(300, 500)]
            ]
        ];
    ...
    {
        $filters = [
            ['id' => 'per_day', 'value' => trans('default.by_school')],
    ...
    public function getBySchool()
    {
        ...
        $filters = [
            ['id' => 'by_school', 'value' => 'Per Day'],
            ['id' => 'by_semester', 'value' => 'By Week']
        ];
